...
@section('container')
    ...
    <div class="content-header">
        <div class="container-fluid ">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="font-size:3rem;">Edit News</h1>
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-6 ">
                        <div class="mb-3 ">
                            ...
                            is-invalid
                        @enderror"
                                id="title" name="title" data-provide="typeahead"
                                value="{{ old('title', $news->title) }}" autofocus required>
                            @error('title')
                        ...
                        <button class="btn btn-light col-md mt-3 mb-3" type="submit" name="submit">Update News</button>

                        <div class="body  text-dark ">
                            <textarea id="editor" name="body" type="text"
                                class="@error('body')
                        is-invalid
                        @enderror">{{ $news->body }}</textarea>
                            @error('body')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-start" style="margin-top: -8rem">
                        <img src="{{ asset('assets/img/newsImgEdit.png') }}" alt="" class="newsImg"
                            style="height:35rem">
                    </div>
                </div>
            </form>
